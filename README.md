...
- `Hermes-Windows-Launcher-v2026.05.04.1.zip`: versioned Windows download linked by `index.html` (任务 014：修复 Bug A 渠道依赖按需安装、Bug B 已安装机器被强制安装模式、Bug C dispatcher FileNotFoundException ~20% 概率崩溃)
